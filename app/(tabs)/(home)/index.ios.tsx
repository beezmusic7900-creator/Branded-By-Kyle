    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={styles.heroTagline}>
              Custom tattoo artistry. Every piece tells your story.
            </Text>
        ...
        >
          <Animated.View
            style={[
              ...
              isTablet && { width: contentMaxWidth },
            ]}
          >
            <AnimBtn
        ...
        <View style={[styles.section, isTablet && { alignItems: "center" }]}>
          <View style={[isTablet && { width: contentMaxWidth }]}>
