...
export default function HomeScreen({ enableHaptics = false }: HomeScreenProps) {
  ...
  const handleInstagramPress = useCallback(() => {
    console.log("[Home] Instagram link pressed — opening @brandedbykyletattoo");
    Linking.openURL("https://www.instagram.com/brandedbykyletattoo/").catch(() => {
      Alert.alert("Could not open Instagram", "Please visit @brandedbykyletattoo on Instagram.");
    });
  }, []);
